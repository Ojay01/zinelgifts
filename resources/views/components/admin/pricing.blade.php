    ...
    <div class="bg-slate-900 rounded-lg p-5 border border-slate-700 mb-6">
        ...
        <div class="flex items-center mb-4">
            <div class="relative inline-block w-12 mr-3 align-middle select-none">
                <input type="checkbox" id="variable" name="variable" value="1" {{ old('variable', $product->variable ?? false) ? 'checked' : '' }}
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="price" name="price" value="{{ old('price',$product->price ?? 0) }}" step="0.01" required
                ...
                <div>
                    <label for="discount" class="block text-sm font-medium text-gray-300 mb-2">Discount
                        Percentage</label>
                    <div class="relative">
                        <input type="number" id="discount" name="discount" value="{{ old('discount', $product->discount ?? 0) }}" min="0"
                            max="100"
            ...
            <div class="flex space-x-4">
                <div class="flex items-center">
                    <input type="radio" 
                           ...
                           name="pricing_type" 
                           value="1"
                           {{ old('attributes.variable_type', $product->attributes->variable_type ?? null) == 1 ? 'checked' : '' }}
                ...
                <div class="flex items-center">
                    <input type="radio" 
                           ...
                           name="pricing_type" 
                           value="2"
                           {{ old('attributes.variable_type', $product->attributes->variable_type ?? null) == 2 ? 'checked' : '' }}
                           class="w-4 h-4 text-blue-600 focus:ring-blue-500 border-gray-600 bg-gray-800">
                ...
                <div class="flex items-center">
                    <input type="radio" 
                           ...
                           name="pricing_type" 
                           value="3"
                           {{ old('attributes.variable_type', $product->attributes->variable_type ?? null) == 3 ? 'checked' : '' }}
                           class="w-4 h-4 text-blue-600 focus:ring-blue-500 border-gray-600 bg-gray-800">
