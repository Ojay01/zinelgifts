...
<script>
   $(document).ready(function () {
    ...
    // Load subcategories for already selected category on page load
    const initialCategoryId = $('#category_id').val();
    if (initialCategoryId) {
        loadSubcategories(initialCategoryId, {{ $product->subcategory_id ?? 'null' }});
    }
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (key, value) {
                        const selected = selectedSubcategoryId && selectedSubcategoryId == value.id ? 'selected' : '';
