...
<x-admin-layout>
    ...
    <div class="mt-4 sm:mt-6 container mx-auto px-4">
                        ...
                        <tr class="hover:bg-slate-700/50 transition-colors">
                            ...
                            <td class="px-3 sm:px-6 py-2 sm:py-4">
                                <div class="flex space-x-2">
                                    <button 
                                        onclick="colorManager.openColorModal('edit', {{ json_encode($type) }})"
                                    ...
                                    <button 
                                        onclick="colorManager.openConfirmModal('{{ route('types.destroy', $type) }}')"
        ...
        >
            <div class="bg-slate-800 rounded-lg p-6 max-w-sm w-full mx-8 md:mx-auto">
                ...
                <form 
                    id="colorForm"
                    data-store-url="{{ route('types.store') }}"
                    data-update-url="{{ route('types.update', '__ID__') }}"
                    method="POST"
                >
                    @csrf
    ...
    class ColorManager {
        ...
        openColorModal(mode, data = null) {
            ...
            if (mode === 'add') {
                this.modalTitle.textContent = 'Add Type';
                ...
                this.modalTitle.textContent = 'Edit Type';
