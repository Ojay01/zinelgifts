...
<x-admin-layout>
    ...
    <div class="mt-4 sm:mt-6 container mx-auto px-4">
                        ...
                        <tr class="hover:bg-slate-700/50 transition-colors">
                            ...
                            <td class="px-3 sm:px-6 py-2 sm:py-4">
                                <div class="flex space-x-2">
                                    <button 
                                        onclick="colorManager.openColorModal('edit', {{ json_encode($quality) }})"
                                    ...
                                    <button 
                                        onclick="colorManager.openConfirmModal('{{ route('qualities.destroy', $quality) }}')"
        ...
        >
            <div class="bg-slate-800 rounded-lg p-6 max-w-sm w-full mx-8 md:mx-auto">
                ...
                <form 
                    id="colorForm"
                    data-store-url="{{ route('qualities.store') }}"
                    data-update-url="{{ route('qualities.update', '__ID__') }}"
                    method="POST"
                >
                    @csrf
        ...
        >
            <div class="bg-slate-800 rounded-lg p-6 max-w-sm mx-8 md:mx-auto">
                ...
                <p class="mb-4 text-gray-400">Are you sure you want to delete this Type? This action cannot be undone.</p>
    ...
    class ColorManager {
        ...
        openColorModal(mode, data = null) {
            ...
            if (mode === 'add') {
                this.modalTitle.textContent = 'Add Quality';
                ...
                this.modalTitle.textContent = 'Edit Quality';
